#!/bin/bash
# Coded by: Aruack (Don't change)
# www.github.com/aruack
# www.instagram.com/official_aruack
...
printf "\n"
printf "\e[1;77m\e[41m  Instagram Brute Forcer v1.0, Author: @Aruack (Github/IG)  \e[0m\n" #Don't change, noob
printf "\n"
}
...
printf "\e[1;92mUse ./instakroor.sh --resume\n"
else
exit 1
fi
else
